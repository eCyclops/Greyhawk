...
[h, code: {
    ...
    [data.setData("addon:", "com.ecyclops.greyhawk", "currentMinute", 1]
    [data.setData("addon:", "com.ecyclops.greyhawk", "currentSegment", 1]
    [data.setData("addon:", "com.ecyclops.greyhawk", "currentWeather", ""]
    [data.setData("addon:", "com.ecyclops.greyhawk", "currentYear", 576]
    [data.setData("addon:", "com.ecyclops.greyhawk", "currentYearDate", 1]

    [r: "Setting month data"]
    [data.setData("addon:", "com.ecyclops.greyhawk", "months",
    ...
    [data.setData("addon:", "com.ecyclops.greyhawk", "weekDays", "Freeday, Starday, Sunday, Moonday, Godsday, Waterday, Earthday")]
